...
public class MyOptionPane extends JOptionPane {
	...
	public static void gameOverLava(JFrame thisGUI, MenuGUI menuGUI, int totalShots) {
		JOptionPane.showMessageDialog(thisGUI, "You hit a lava poddle, shots increased by 10! Total shots " + totalShots + "!", "Be careful next time!", JOptionPane.PLAIN_MESSAGE);
		thisGUI.dispose();
		menuGUI.setVisible(true);
	}
